...
let caseUpdate = {
	...
	this.updateFunc({ accids: this.accountName, type: SYMPTOM, email: this.isCheckboxSympEmail, sms: this.isCheckboxSympSms, insite: true, phone: this.isCheckboxSympPhone });
	this.updateFunc({ accids: this.accountName, type: QUESTIONNAIRES, email: this.isCheckboxQuesEmail, sms: this.isCheckboxQuesSms, insite:true, phone: this.isCheckboxQuesPhone });
	this.updateFunc({ accids: this.accountName, type: CHALLENGES, email: this.isCheckboxChalEmail, sms: this.isCheckboxChalSms, insite: true, phone: this.isCheckboxChalPhone });
	this.updateFunc({ accids: this.accountName, type: NEW_CONTENT, email: this.isCheckboxNewEmail, sms: this.isCheckboxNewSms, insite: true, phone: this.isCheckboxNewPhone });
	this.updateFunc({ accids: this.accountName, type: COMMUNITY, email: this.iscommunityEmail, sms: '', insite: true, phone: '' });
}
