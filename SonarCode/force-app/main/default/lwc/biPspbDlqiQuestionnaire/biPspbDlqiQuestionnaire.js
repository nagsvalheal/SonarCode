...
export default class BiPspbDlqiQuestionnaire extends LightningElement {
	...
	*/
	...
	submitResponses() {
		...
		if (typeof this.seventhDraftResp !== 'undefined') {
			this.nameToDraftSeventh = 'nameseven';
		}
		if (typeof this.eigthDraftResp !== 'undefined') {
			this.nameToDraftEighth = 'nameeigth';
		}
		if (typeof this.ninthDraftResp !== 'undefined') {
			this.nameToDraftNinth = 'nameninth';
		}
		if (typeof this.tenthDraftResp !== 'undefined') {
			this.nameToDrafttenth = 'nametenth';
		}
		if (typeof this.eleventhDraftResp !== 'undefined') {
		...
		if (this.eigthQuestionVisible === true) {
			if (
				...
				typeof this.nameToDraftEleventh !== 'undefined'
			) {
