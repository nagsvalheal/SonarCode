...
export default class biPspbSymptomTracker extends NavigationMixin(
    ...
    @track symptomrecordValuesbtn;
    @api recordId;
    //@track variable declaration
    @track symptomCompleteTick = SYMPTOM_TICK_IMG;
    @track itchinessColorVarient = ITCHINESS_COLOR_VARIENT;
    @track rednessColorVarient = REDNESS_COLOR_VARIENT;
    @track painColorVarient = PAIN_COLOR_VARIENT;
    @track pustulesColorVarient = PUSTULES_COLOR_VARIENT;
    @track fatigueColorVarient = FATIGUE_COLOR_VARIENT;
    @track moodColorVarient = MOOD_COLOR_VARIENT;
    @track temperatureColorVarient = TEMPERATURE_COLOR_VARIENT;
    @track symptomTickIcon = SYMPTOM_TICK_ICON;
    @track lasteDatedIsPlay = false;
    @track isDeskTop = false;
    @track rednessChange = false;
    @track painChange = false;
    @track pustlesChange = false;
    @track fatiquesChange = false;
    @track moodChange = false;
    @track temperatureChange = false;
    @track sliderValue = 8;
    @track whichValuesOne = "Which of the below apply to your recent";
    @track boxedIcon = BOXED_ICON;
    @track limtUpLoad = UPLOAD_IMG;
    @track accName;
    ...
    @track colorChange5 = "";
    @track colorChange6 = "";
    @track itchinessChange1 = false;
    @track formattedLastModifiedDate;
    @track lastModifiedTime;
    @track accordColor;
    @track accordColorSymptom;
    @track itchinessChange = false;
    @track primaryPage;
    @track extraImg;
    ...
    @track fileChangeColour;
    @track fileWork = false;
    @track fileMessage = false;
    @track isEditMode = false;
    @track resultId;
    @track dataMandatory = false;
    ...
    @track whichSymptom;
    @track fileTitle = UPLOADED_FILE;
    @track filePath = UPLOADED_FILE_PNG;
    @track Editdatedisable = false;
